...
public class StringCompressorTests
{
    ...
    [InlineData("", "")]                        // пустая строка
    [InlineData("x1", "x")]                     // число 1 (по условию не должно встречаться, но декомпрессия должна работать)
    ...
    // Проверяем, что сжатие + декомпрессия дают исходную строку
    ...
    [InlineData("mmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmmm")] // длинная строка
